...
public class ContentTypeKit {
	...
	static {
		map.put(null, DEFAULT_CONTENT_TYPE);
	...
	public static String getContentType(String format) {
		String key = StringUtils.lowerCase(format);
		return map.containsKey(key) ? String.valueOf(map.get(key)) : DEFAULT_CONTENT_TYPE;
	}
}